...
{
    /// <inheritdoc />
    public partial class AddInitialListingSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Cooking facilities", "Kitchen" },
                    { 3, "Air conditioning system", "Air Conditioning" },
                    { 4, "Heating system", "Heating" },
                    { 5, "Television", "TV" },
                    { 6, "Swimming pool", "Pool" },
                    { 7, "Jacuzzi or hot tub", "Hot Tub" },
                    { 8, "Free parking on premises", "Free Parking" },
                    { 9, "Pets allowed", "Pet Friendly" },
                    { 10, "Smoking permitted", "Smoking Allowed" }
                });
